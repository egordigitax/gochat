...
func (m *MessageService) GetMessagesHistory(chatUID string, limit, offset int) ([]types.Message, error) {
...
func (m *MessageService) SaveMessagesBulk(msgs ...types.Message) error {
